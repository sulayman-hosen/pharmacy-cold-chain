...
export function AuditCertificateModal({ verification, totalCount, onClose, t }) {
  ...
  return (
    <Modal
      wide
      title="Audit Compliance Certificate"
      subtitle="Official HIPAA / HL7 FHIR Security Audit Report"
      onClose={onClose}
    >
      <div
      ...
      >
        ...
        >
          <div>
            <strong style={{ fontSize: 18, color: '#0f172a', display: 'block' }}>
              COLDLINE AUDIT & COMPLIANCE CERTIFICATE
            </strong>
            <p style={{ margin: '2px 0 0', fontSize: 12, color: '#64748b' }}>
              HL7 FHIR R4 AuditEvent Specification · HIPAA § 164.312(b)
            </p>
          </div>
          <span
            className="small-tag"
        ...
        >
          ...
          >
            <small style={{ fontSize: 11, color: '#0369a1', fontWeight: 700, display: 'block' }}>
          ...
          >
            <small style={{ fontSize: 11, color: '#64748b', fontWeight: 700, display: 'block' }}>
              HEAD HMAC-SHA256 CHECKSUM HASH
            </small>
            <code
              style={{
                fontSize: 11,
