...
export function PrintDeliverySlipModal({ row, onClose, t }) {
  ...
  return (
    <Modal
      title={t?.printSlip || 'Print Box Manifest Label'}
      subtitle="Cold chain delivery slip with complete location & courier info."
      onClose={onClose}
    >
      <div className="print-manifest" style={{ border: '1px solid #cbd5e1', borderRadius: 8, padding: 16, background: '#ffffff' }}>
        ...
        <div className="print-barcode" style={{ textAlign: 'center', marginTop: 12 }}>
          <svg width="220" height="45" viewBox="0 0 220 50">
            ...
            <path
              d="M10 5h4v40h-4zM20 5h2v40h-2zM28 5h6v40h-6zM40 5h2v40h-2zM48 5h8v40h-8zM60 5h4v40h-4zM70 5h2v40h-2zM78 5h6v40h-6zM90 5h4v40h-4zM100 5h2v40h-2zM108 5h8v40h-8zM122 5h4v40h-4zM132 5h2v40h-2zM140 5h6v40h-6zM152 5h4v40h-4zM162 5h8v40h-8zM176 5h4v40h-4zM186 5h2v40h-2zM194 5h6v40h-6z"
              fill="#0f172a"
            />
          </svg>
          <small style={{ letterSpacing: 2, fontFamily: 'monospace', fontSize: 11, display: 'block' }}>
            *{row.prescriptionId}*
          </small>
        </div>
      ...
      <div className="modal-actions">
        ...
        <Button onClick={triggerPrint}>
          <Printer size={16} /> Print Label Manifest
        </Button>
      </div>
    </Modal>
  );
